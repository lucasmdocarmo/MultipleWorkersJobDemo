...
{
    public class JobServ2 : CronJobService
    {
        private readonly ILogger<JobServ2> _logger;
        private readonly IServiceProvider _serviceProvider;

        public JobServ2(IScheduleConfig<JobServ2> config, ILogger<JobServ2> logger, IServiceProvider serviceProvider)
